...
#' @description
#' Simple random sampling without replacement based on paper: "Statistics and game theory: Estimating coalitional values
#' in R software" (A. Saavedra-Nieves, 2020) Algorithm 2
