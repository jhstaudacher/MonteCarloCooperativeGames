...
- Required and Optional tags in this order: (These are very opinionated rules to keep the documentation tidy and consistent):
  ...
  - ``` @details ``` (Optional): Explain how the algorithm works internally and any other useful information. Anything that is not required to use the function but still useful. If required, this can be organized with the ```@section Section_Name: ``` tag
