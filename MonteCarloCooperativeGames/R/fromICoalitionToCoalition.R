...
#' @title Access possible coalitions of players through index
#' @description Based on: "Statistics and game theory: Estimating coalitional values in R software" (Alejandro Saavedra-Nieves, 2020)
